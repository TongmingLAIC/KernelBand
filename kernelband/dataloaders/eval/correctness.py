...
def _compare(tri, pyt, fname, atol=1e-4, rtol=1e-4, verbose=False):
...
def compare(ref, gen, fname, atol=1e-4, rtol=1e-4, verbose=False):
    ret_val = True
...
def test_correctness(ref_file, gen_file, var_name, atol=1e-4, rtol=1e-4, verbose=False):
