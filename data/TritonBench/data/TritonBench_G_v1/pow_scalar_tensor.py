...
# Use platform-independent pow implementation
# triton's ** operator or tl.math functions work on both NVIDIA and AMD
...
def pow_func_scalar_tensor(x, exponent):
    # Use triton's native exp/log for pow: x^y = exp(y * log(x))
    # This is platform-independent and works on both NVIDIA and AMD
    x_f32 = x.to(tl.float32)
    return tl.exp(exponent * tl.log(tl.abs(x_f32) + 1e-10))
