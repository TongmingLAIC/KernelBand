...
def token_att_fwd2(
    ...
    # Fix: kv_group_num should be head // kv_head, i.e., prob.shape[0] // v.shape[0]
    # Previously was prob.shape[0] // v.shape[1] which equals head // seq_len = 0, causing division by zero
    kv_group_num = prob.shape[0] // v.shape[0]
